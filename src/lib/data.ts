...
export const calendarEvents = [
  {
    title: "Math",
    allDay: false,
    start: new Date(2026, 2, 20, 8, 0),
    end: new Date(2026, 2, 20, 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2026, 2, 20, 9, 0),
    end: new Date(2026, 2, 20, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2026, 3, 20, 10, 0),
    end: new Date(2026, 3, 20, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2026, 3, 20, 11, 0),
    end: new Date(2026, 3, 20, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2026, 3, 20, 13, 0),
    end: new Date(2026, 3, 20, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2026, 3, 20, 14, 0),
    end: new Date(2026, 3, 20, 14, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2026, 2, 19, 9, 0),
    end: new Date(2026, 2, 19, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2026, 2, 19, 10, 0),
    end: new Date(2026, 2, 19, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2026, 2, 19, 11, 0),
    end: new Date(2026, 2, 19, 11, 45),
  },

  {
    title: "History",
    allDay: false,
    start: new Date(2026, 2, 19, 14, 0),
    end: new Date(2026, 2, 19, 14, 45),
  },
  {
    title: "Math",
    allDay: false,
    start: new Date(2026, 2, 18, 8, 0),
    end: new Date(2026, 2, 18, 8, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2026, 2, 18, 10, 0),
    end: new Date(2026, 2, 18, 10, 45),
  },

  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2026, 2, 18, 13, 0),
    end: new Date(2026, 2, 18, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2026, 2, 18, 14, 0),
    end: new Date(2026, 2, 18, 14, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2026, 2, 17, 9, 0),
    end: new Date(2026, 2, 17, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2026, 2, 17, 10, 0),
    end: new Date(2026, 2, 17, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2026, 2, 17, 11, 0),
    end: new Date(2026, 2, 17, 11, 45),
  },

  {
    title: "History",
    allDay: false,
    start: new Date(2026, 3, 17, 14, 0),
    end: new Date(2026, 3, 17, 14, 45),
  },
  {
    title: "Math",
    allDay: false,
    start: new Date(2026, 2, 16, 8, 0),
    end: new Date(2026, 2, 16, 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2026, 2, 16, 9, 0),
    end: new Date(2026, 2, 16, 9, 45),
  },

  {
    ...
    end: new Date(2026, 2, 16, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2026, 2, 16, 13, 0),
    end: new Date(2026, 2, 16, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2026, 2, 16, 14, 0),
    end: new Date(2026, 2, 16, 14, 45),
  },
];