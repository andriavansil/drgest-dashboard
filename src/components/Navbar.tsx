...
const Navbar = () => {
  return (
    <div className='flex items-center justify-between p-4'>
      {/* SEARCH BAR */}
      <div className='lg:hidden bg-white rounded-full w-8 h-8 flex items-center justify-center cursor-pointer'>
      ...
      <div className='flex items-center gap-6 justify-end w-full'>
        ...
        <div className='flex flex-col'>
          ...
          <span className="text-[10px] text-gray-500 text-right">Cardiologista</span>
        </div>
